...
def main():
  ...
  # path = "../Edge_Extraction/ArtificialPointClouds/SpherMultiple.pcd"
  
  # path = "../Edge_Extraction/detected_edge/sphereMultipleEdges.ply"
  path = "sphereMultiple_edges.pcd"
  pcd = o3d.io.read_point_cloud(path, format="pcd")
  pcd.paint_uniform_color([1, 0.706, 0]) # yellow 
  # pcd.paint_uniform_color([1, 0, 1]) # magenta
  # o3d.io.write_point_cloud("sphereMultiple_edges.pcd", pcd)
